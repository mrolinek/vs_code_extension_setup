...
function getMarkdownMessage(context, message) {
...
function renderDecoration(delay = 10) {
    ...
    decorationsDebounce = setTimeout(() => {
        var _a;
        return decoration && ((_a = vscode_1.window.activeTextEditor) === null || _a === void 0 ? void 0 : _a.setDecorations(decorationType, [decoration]));
    }, delay);
}
